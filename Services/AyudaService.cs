...
namespace Airbnb.Services
{
    public class AyudaService
    {
        ...
        public AyudaService(IMarcatelDatabaseSetting settings, IWebHostEnvironment webHostEnvironment)
        {
        ...
        public List<GetAyudaModel> GetAyuda()
        {
            ConexionDataAccess dac = new ConexionDataAccess(connection);
            GetAyudaModel sedes = new GetAyudaModel();

            List<GetAyudaModel> lista = new List<GetAyudaModel>();
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                  ...
                  lista = ds.Tables[0].AsEnumerable()
                    .Select(dataRow => new GetAyudaModel {
